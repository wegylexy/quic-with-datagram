...
public abstract class QuicConnectionOptions
{
    ...
    internal virtual void Validate(string argumentName)
    {
        ...
        {
            throw new ArgumentOutOfRangeException(string.Format(SR.net_quic_in_range, nameof(QuicConnectionOptions.MaxInboundBidirectionalStreams), ushort.MaxValue), argumentName);
        }
        if (MaxInboundUnidirectionalStreams < 0 || MaxInboundUnidirectionalStreams > ushort.MaxValue)
        {
            throw new ArgumentOutOfRangeException(string.Format(SR.net_quic_in_range, nameof(QuicConnectionOptions.MaxInboundUnidirectionalStreams), ushort.MaxValue), argumentName);
        }
        ...
        {
            throw new ArgumentOutOfRangeException(string.Format(SR.net_quic_in_range, nameof(QuicConnectionOptions.DefaultStreamErrorCode), QuicDefaults.MaxErrorCodeValue), argumentName);
        }
        if (DefaultCloseErrorCode < 0 || DefaultCloseErrorCode > QuicDefaults.MaxErrorCodeValue)
        {
            throw new ArgumentOutOfRangeException(string.Format(SR.net_quic_in_range, nameof(QuicConnectionOptions.DefaultCloseErrorCode), QuicDefaults.MaxErrorCodeValue), argumentName);
        }
    }
}
...
public sealed class QuicClientConnectionOptions : QuicConnectionOptions
{
    ...
    internal override void Validate(string argumentName)
    {
        ...
        {
            throw new ArgumentNullException(string.Format(SR.net_quic_not_null_open_connection, nameof(QuicClientConnectionOptions.ClientAuthenticationOptions)), argumentName);
        }
        if (RemoteEndPoint is null)
        {
            throw new ArgumentNullException(string.Format(SR.net_quic_not_null_open_connection, nameof(QuicClientConnectionOptions.RemoteEndPoint)), argumentName);
        }
    }
}
...
public sealed class QuicServerConnectionOptions : QuicConnectionOptions
{
    ...
    internal override void Validate(string argumentName)
    {
        ...
        {
            throw new ArgumentNullException(string.Format(SR.net_quic_not_null_accept_connection, nameof(QuicServerConnectionOptions.ServerAuthenticationOptions)), argumentName);
        }
    }
}
