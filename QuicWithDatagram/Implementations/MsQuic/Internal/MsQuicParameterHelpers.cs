...
namespace System.Net.Quic.Implementations.MsQuic.Internal
{
    internal static class MsQuicParameterHelpers
    {
        ...
        internal static unsafe byte GetByteParam(MsQuicApi api, SafeHandle nativeObject, QUIC_PARAM_LEVEL level, uint param)
        {
            byte value;
        ...
        internal static unsafe void SetByteParam(MsQuicApi api, SafeHandle nativeObject, QUIC_PARAM_LEVEL level, uint param, byte value)
        {
            QuicExceptionHelpers.ThrowIfFailed(
