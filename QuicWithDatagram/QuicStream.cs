...
public sealed partial class QuicStream
{
    ...
    public override async ValueTask<int> ReadAsync(Memory<byte> buffer, CancellationToken cancellationToken = default)
    {
        ...
        do
        {
            ...
            {
                throw new InvalidOperationException(string.Format(SR.net_io_invalidnestedcall, "read"));
            }
    ...
    public ValueTask WriteAsync(ReadOnlyMemory<byte> buffer, bool completeWrites, CancellationToken cancellationToken = default)
    {
        ...
        {
            throw new InvalidOperationException(string.Format(SR.net_io_invalidnestedcall, "write"));
        }
